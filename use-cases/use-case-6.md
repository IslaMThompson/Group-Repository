# USE CASE: 6 Produce a report on a given number of capital cities with the highest population in a given area (globe, continent, region) from highest population to lowest
